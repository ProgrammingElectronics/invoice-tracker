...
//		System.out.println(body + "I AM THE BODY!!!!!!!!");
//		System.out.println(newInvoice + "HERE I AM!!!!!!!!!!!!!!!!!!!!!!!");
...
//		String contractorName = newInvoice.getJSONObject("contractorJson").getString("contractorName");
