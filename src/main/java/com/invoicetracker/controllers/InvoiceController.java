...
// newInvoice.getJSONObject("invoiceNumbersJson").getString("invoiceDate");
// LocalDate localDate = LocalDate.parse(dateOfInvoice);
// Invoice invoice = new Invoice(localDate);
//
// int invoiceNumber =
// newInvoice.getJSONObject("invoiceNumbersJson").getInt("invoiceNumber");
